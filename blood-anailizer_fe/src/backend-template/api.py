...
class GeneratedReport(BaseModel):
    # pdf_blob: Union[bytearray, bytes]
    pdf_blob: Optional[bytes]
...
async def analyze_blood_test(
    ...
    try:
        ...
        report = generate_report_from_df(data_df, language=language, user_type=user_type)
